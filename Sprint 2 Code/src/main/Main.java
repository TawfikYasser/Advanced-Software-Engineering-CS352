...
public class Main {
	...
	public static CRUDMemory accessLayerMemory;
	public static CRUDDB accessLayerDB;
	...
	public static void initDefaultData() {
		accessLayerMemory = new CRUDMemory();
		...
		accessLayerMemory.notifications.add(new NotificationTemplate("Confirmation Mail","Please, Verify your account by entering -v-",
				"0","1",LanguageEnum.ENGLISH,TypeEnum.EMAIL));
		
		accessLayerMemory.notifications.add(new NotificationTemplate("Forget Password","Please, Enter a new password ",
				"0","1",LanguageEnum.ENGLISH,TypeEnum.EMAIL));
	
		accessLayerMemory.notifications.add(new NotificationTemplate("Welcome","Welcome to our booking system",
				"0","0",LanguageEnum.ENGLISH,TypeEnum.EMAIL));
		

		accessLayerMemory.notifications.add(new NotificationTemplate("Book Item","Dear & , your booking of the * is confirmed. thanks for using our store :) ",
				"2","2",LanguageEnum.ENGLISH,TypeEnum.EMAIL));
		
		accessLayerMemory.notifications.add(new NotificationTemplate("Cancel booking","Dear & , your booking of the * is canceled. thanks for using our store :)",
				"2","2",LanguageEnum.ENGLISH,TypeEnum.EMAIL));
		
		
		accessLayerMemory.notifications.add(new NotificationTemplate("Feedback","Please write your feedback about our store",
				"0","1",LanguageEnum.ENGLISH,TypeEnum.EMAIL));
	...
	public static void signUp() {
		...
		String verify = "";
		do {
			System.out.println(accessLayerMemory.notifications.get(0).getTemplateContent());
			...
			if (flagy == 0) {
				do {
					...
					if (check.equals("0")) {
						...
						System.out.println(accessLayerMemory.notifications.get(1).getTemplateContent());
	...
	public static void userMenu(User user) {
		...
		accessLayerMemory.notifications.get(0).getTemplateContent();
	...
	public static void adminMenu(int i) {
		...
		do {
			...
			case 1: {
				...
				accessLayerMemory.create(inputMain);
				mainMenu();
				break;
			}
			case 2: {
				// Call update function
				accessLayerMemory.update(inputMain);
				mainMenu();
				break;
			}
			case 3: {
				// Call delete function
				accessLayerMemory.delete(inputMain);
				mainMenu();
				break;
			}
			case 4: {
